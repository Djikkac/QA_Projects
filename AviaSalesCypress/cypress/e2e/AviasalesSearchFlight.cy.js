...
describe('Search Flight on Aviasales.com', () => {
  it('passes', () => {
    // navigate to base url: https://aviasales.com
    cy.visit('/')
    ...
    cy.get('[data-test-id=origin-autocomplete-field]').should('have.value', 'New York')

    // assert: TO field is set as Berlin
    cy.get('[data-test-id=destination-autocomplete-field]').should('have.value', 'Berlin')
